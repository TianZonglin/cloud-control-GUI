ANN: Approximate Nearest Neighbors - Thread safe version
Version: 1.1.1.ts
Release Date: March 16, 2009
----------------------------------------------------------------------------

This library has been modified by Sylvain Lefebvre ( http://www-sop.inria.fr/reves/Sylvain.Lefebvre )
to support calls from different threads. Original ReadMe notice is below.
